   ...
   <div id="wrapper">
		...
		<?=anchor('user/logout', 'Logout')?>
		 ...
		 <div id="navigation">
             ...
             <span class="active"><?php echo anchor('vibhag/view/' . $this->session->userdata('vibhag_id'), 'My Vibhag'); ?></span>
...
<!-- End Navigation -->
         ...
         <h3>Navigation </h3>
         <p><?=anchor('vibhag/browse/'.$this->uri->segment(3). '/name/', 'List Contacts');?></p>
         <p><?=anchor('vibhag/add_shakha/'.$this->uri->segment(3), 'Add Shakha');?></p>
         <p><?=anchor('vibhag/responsibilities/'.$this->uri->segment(3), 'Manage Responsibilities');?></p>
	   	 <p>Vibhag Statistics</p>
	  <p>&nbsp;</p>
	  <p><?=anchor('vibhag/email_lists/'.$this->uri->segment(3), 'Email Lists');?></p>
