...
<h2><?=$national->name?> - Edit E-mail List</h2>
...
<?=form_hidden('level', 'NT');?>
  <table width="650" border="0" align="left" cellpadding="2" cellspacing="5">
    ...
    <tr valign="middle">
      ...
      <td width="276"><label>
        <span class="style1">
        <input name="members[]" type="checkbox" id="checkbox" value="ntkk" <?php if(in_array('ntkk', $members)) echo 'checked="checked"';?> />
        </span></label>
    ...
    <tr valign="middle">
      ...
      <td>&nbsp;</td>
      <td><label>
        <input name="members[]" type="checkbox" id="checkbox" value="sakk" <?php if(in_array('sakk', $members)) echo 'checked="checked"';?>/>
    ...
    <tr valign="middle">
      ...
      <td><label><span class="style2">
        <input name="members[]" type="checkbox" id="checkbox" value="vikk" <?php if(in_array('vikk', $members)) echo 'checked="checked"';?>/>
      </span></label>
    ...
    <tr valign="middle">
      <td align="right">&nbsp;</td>
      <td><form id="form1" name="form1" method="post" onsubmit="return confirmSubmit()" action="<?php echo '/national/del_list/',$this->uri->segment(3);?>">
