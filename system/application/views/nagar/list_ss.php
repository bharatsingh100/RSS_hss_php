...
for($i = 0; $i < $total_rows; $i++)
{
	...
	if(is_array($sharr) && $vars[$i]['shakha_id'] != '')
		$vars[$i]['shakha_id'] = anchor('shakha/browse/'. $vars[$i]['shakha_id'].'/name', $sharr[$vars[$i]['shakha_id']]);
...
?>
<h2><?=$nagar_name?> Nagar</h2>
<div align="right"><?=anchor('/nagar/csv_out/' . $this->uri->segment(3), 'Download to Excel');?></div>
