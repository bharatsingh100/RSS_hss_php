...
<h2><?=$shakha_name?></h2>
		     ...
		     <table width="100%" border="0" cellpadding="2" cellspacing="4">
               ...
               <tr>
                 ...
                 <td width="9%">
                   <input name="ph_mobile" type="text" id="ph_mobile" size="15" maxlength="14" value="<?php echo ($m->ph_mobile == '') ? 'Mobile...' : $m->ph_mobile;?>"/>
                   <br /><span class="style2">Mobile</span></td>
                 <td width="9%"><input name="ph_home" type="text" id="ph_home" size="15" onclick="this.value = '';" maxlength="12"
                    value="<?php echo ($m->ph_home == '') ? 'Home...' : $m->ph_home;?>"/><br />
                 <span class="style2">Home</span></td>
                 <td width="63%"><input name="ph_work" type="text" id="ph_work" value="<?php echo ($m->ph_work == '') ? 'Work...' : $m->ph_work;?>" maxlength="14" size="15" />
                 <br />
