...
|
*/
$config['base_url']	= "https://sampark.lndo.site/";
...
|
*/
$config['encryption_key'] = "Vishwa Mangal Kamana Ke Hum Hai Maun Pujari";
...
$config['sess_timeout']             = 36000; 
$config['sess_destroy_on_timeout']  = TRUE; 
$config['sess_update_interval']     = 1800; 
$config['sess_gc_probability']      = 95;
...
//Trun Profiler On/Off
$config['debug'] = FALSE;

// SNY Year
$config['sny_year'] = 2015;
